...
This code allows you to connect hadrware buttons and a rotary encoder to the GPIOs of a Raspberry Pi with the latested Raspberry Pi OS Bookwork (Linux 6.6 Kernel) in the Photooboth Project of Andreas Skomski. Support in the Photobooth Project was broken as Linux 6.6 Kernel was not able to handle the GPIO buttons via sysfs anymore.
...
Start the script with the command "python3 gpiosupport.py" or set it up as an autostart script (cronjob/service). 
